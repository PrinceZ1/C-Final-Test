...
Q dòng tiếp theo mô tả truy vấn gồm 4 số : số thứ nhất là loại truy vấn (1 hoặc 2), 
nếu truy vấn loại 1 3 số tiếp theo sẽ là x, y, z, nếu là truy vấn loại 2 thì 3 số tiếp theo sẽ là u, v, t.
